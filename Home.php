...
<html>
	...
	<body>
		...
		<section class="container list item-list">
			<ul>
				<li>
					<a class="item" href="Start Room.php">Start Room<i class="fa fa-angle-right"></i></a>
				</li>
				<li>
					<a class="item" href="Join Room.php">Join Room<i class="fa fa-angle-right"></i></a>
				</li>
				<li>
					<a class="item" href="Manage Playlists.php">Manage Playlists<i class="fa fa-angle-right"></i></a>
				</li>
			</ul>
		</section>
		<section class="container nav">
			<center>
				<a class="icon" href="Home.php"><i class="fa fa-home" style="color: #FFFFFF;"></i></a>
